...
|      BM25para + DPR (top 1000) Retrieval Recall |                         | @5=.55 @10=.62 @20=.65 | @5=.64 @10=.71 @20=.76 |? @5=.42 @10=.52 @20=.61 |                        |                           |
...
|  BM25para + DPR (top 1000)  Retrieval Precision |                         | @5=.29 @10=.26 @20=.22 | @5=.34 @10=.29 @20=.25 |? @5=.16 @10=.14 @20=.12 |                        |                           |
...
| BM25para + DPR (top 1000) + Electra (top 20) F1 |                         | mean=.278 std=.417     | mean=.188 std=.357     |? mean=.302 std=.421     |                        |                           |
...
| BM25para + DPR (top 1000) + Electra (top 20) EM |                         | mean=.211 std=.408     | mean=.123 std=.328     |? mean=.226 std=.418     |                        |                           |
